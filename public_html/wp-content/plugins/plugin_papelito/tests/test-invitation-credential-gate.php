...
$pending = papelito_auth_handle_invitation_register(
	new WP_REST_Request(
		array( 'token' => 'token-valido', 'email' => 'convidado@test.com', 'password' => 'SenhaDoAtacante1', 'first_name' => 'Ana', 'last_name' => 'Silva' )
	)
);
...
$created = papelito_auth_handle_invitation_register(
	new WP_REST_Request(
		array( 'token' => 'token-novo', 'email' => 'novo@test.com', 'password' => 'SenhaEscolhida1', 'first_name' => 'Bruno', 'last_name' => 'Costa' )
	)
);
