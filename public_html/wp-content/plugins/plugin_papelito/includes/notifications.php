...
if ( ! defined( 'PAPELITO_NOTIF_NEW_VENDOR_APPLICATION' ) ) {
	...
	define( 'PAPELITO_NOTIF_RETURN_REQUESTED', 'return_requested' );
	define( 'PAPELITO_NOTIF_RETURN_OPENED', 'return_opened' );
	define( 'PAPELITO_NOTIF_RETURN_AUTHORIZATION_ISSUED', 'return_authorization_issued' );
	define( 'PAPELITO_NOTIF_RETURN_TRACKING_UPDATED', 'return_tracking_updated' );
	define( 'PAPELITO_NOTIF_RETURN_REFUNDED', 'return_refunded' );
...
function papelito_notification_allowed_types() {
	return array(
		...
		PAPELITO_NOTIF_RETURN_REQUESTED,
		PAPELITO_NOTIF_RETURN_OPENED,
		PAPELITO_NOTIF_RETURN_AUTHORIZATION_ISSUED,
		PAPELITO_NOTIF_RETURN_TRACKING_UPDATED,
		PAPELITO_NOTIF_RETURN_REFUNDED,
